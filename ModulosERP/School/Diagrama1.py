...
class school_course(osv.osv):
    ...
    _columns = {
        ...
        'prof_id': fields.many2one('school.professor', 'Professor', required=True),
...
class school_student(osv.osv):
    ...
    _columns = {
        ...
        'subscriptions': fields.many2many('school.course', 'course_student_suscription_rel', 'course_id', 'student_id', 'Suscriptions'),
    }
school_student()
